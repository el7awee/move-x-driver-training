...
const cards=[["المستخدمون","/admin/settings/users"],["السائقون","/admin/settings/users?role=driver"],["المشرفون","/admin/settings/users?role=supervisor"],["السيارات","/admin/settings/vehicles"],["تخصيص السيارات","/admin/settings/assignments"],["الدورات","#courses"],["سجل العمليات","/admin/settings/audit"],["إعدادات عامة","#general"]];
