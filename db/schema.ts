...
export const driverProfiles = sqliteTable("driver_profiles", {
  ...
  nationalIdExpiry: text("national_id_expiry"),
  nationalIdCardSerial: text("national_id_card_serial"),
  drivingLicenseNumber: text("driving_license_number"),
  drivingLicenseType: text("driving_license_type"),
  drivingLicenseTrafficDepartment: text("driving_license_traffic_department"),
  drivingLicenseTrafficUnit: text("driving_license_traffic_unit"),
  drivingLicenseCategory: text("driving_license_category"),
